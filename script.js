...
function openWindow(appName) {
    ...
    switch(appName) {
        case 'about':
            title = 'About Me';
            content = `<div class="profile-section" style="color: #cbd5e0; font-size: 0.9em; line-height: 1.6;"><h3 style="color: #ffffff; margin-bottom: 12px;">Hi, I'm Sripad Nadella</h3><p style="margin-bottom: 12px;">High school student and hobbyist developer, passionate about AI, design, and technology.</p><p style="margin-bottom: 12px;">I enjoy turning ideas into small personal projects that solve practical problems. My interests span software development, artificial intelligence, design, and data-driven thinking.</p><p style="margin-bottom: 16px;">I've built several personal, non-commercial projects across analytics, education, and research - purely for learning. As a team captain in basketball and cricket, I developed leadership and teamwork skills. My long-term goal is to study Management Information Systems and keep learning by building.</p><div style="background: rgba(255, 255, 255, 0.1); border: 1px solid rgba(255, 255, 255, 0.2); padding: 12px; border-radius: 6px;"><strong style="color: #ffffff;">Skills:</strong><div style="margin-top: 8px; font-size: 0.85em;"><strong>Technical:</strong> JavaScript • Python • SQL • HTML/CSS • Supabase • Vercel • Database Design • API Integration • AI-Assisted Development</div><div style="margin-top: 6px; font-size: 0.85em;"><strong>Learning:</strong> Product Design • User Research • Writing • Public Speaking</div><div style="margin-top: 6px; font-size: 0.85em;"><strong>Leadership:</strong> Team Management • Community Building • Public Speaking • Strategic Planning</div></div><div style="margin-top: 10px; font-size: 0.8em; color: #94a3b8;">All projects shown here are personal, educational, and non-commercial.</div></div>`;
            break;
        case 'projects':
            title = 'Projects';
            content = `<div style="color: #cbd5e0; font-size: 0.8em; line-height: 1.4;"><p style="margin: 0 0 12px 0; font-size: 0.75em; color: #94a3b8;">Personal, non-commercial projects built for learning.</p><div style="margin-bottom: 10px;"><h4 style="color: #ffffff; margin: 0 0 4px 0; font-size: 0.9em;">Socle</h4><p style="margin: 0 0 4px 0; font-size: 0.75em;">A personal project exploring AI analysis of guest feedback to surface trends and improvements. Built for learning.</p><span class="tag" style="font-size: 0.7em;">AI</span> <span class="tag" style="font-size: 0.7em;">Analytics</span></div><div style="margin-bottom: 10px;"><h4 style="color: #ffffff; margin: 0 0 4px 0; font-size: 0.9em;">TrueCost</h4><p style="margin: 0 0 4px 0; font-size: 0.75em;">A personal finance experiment that converts purchases into work hours to make spending feel more tangible.</p><span class="tag" style="font-size: 0.7em;">Finance</span></div><div style="margin-bottom: 10px;"><h4 style="color: #ffffff; margin: 0 0 4px 0; font-size: 0.9em;">Biology EOC Prep</h4><p style="margin: 0 0 4px 0; font-size: 0.75em;">A free study resource for Georgia Biology exams, shared with students. Non-commercial.</p><span class="tag" style="font-size: 0.7em;">Education</span></div><div><h4 style="color: #ffffff; margin: 0 0 4px 0; font-size: 0.9em;">The Climate Note</h4><p style="margin: 0; font-size: 0.75em;">Int'l student environmental community. Built a global network with multi-country contributors.</p><span class="tag" style="font-size: 0.7em;">Community</span></div></div>`;
            break;
        case 'portfolio':
            title = 'Portfolio';
            content = `<div style="color: #cbd5e0; font-size: 0.8em; line-height: 1.5;"><h3 style="color: #ffffff; margin-top: 0; margin-bottom: 10px; font-size: 1em;">Activities & Projects</h3><div style="margin-bottom: 10px;"><h4 style="color: #ffffff; margin: 0 0 4px 0; font-size: 0.9em;">Personal Projects</h4><p style="margin: 0 0 4px 0; font-size: 0.75em;">Built several personal, non-commercial software projects for learning - design, development, and iteration.</p></div><div style="margin-bottom: 10px;"><h4 style="color: #ffffff; margin: 0 0 4px 0; font-size: 0.9em;">President, The Climate Note</h4><p style="margin: 0 0 4px 0; font-size: 0.75em;">Built international student community. Managed contributors, content strategy, org growth.</p></div><div style="margin-bottom: 10px;"><h4 style="color: #ffffff; margin: 0 0 4px 0; font-size: 0.9em;">Team Captain</h4><p style="margin: 0 0 4px 0; font-size: 0.75em;">Basketball & Cricket. Led practices, communication, developed leadership skills.</p></div><div style="margin-bottom: 10px;"><h4 style="color: #ffffff; margin: 0 0 4px 0; font-size: 0.9em;">Research Lead</h4><p style="margin: 0 0 4px 0; font-size: 0.75em;">Student Insight Lab. Survey design, data collection, statistical analysis.</p></div><div style="border-top: 1px solid rgba(255, 255, 255, 0.2); padding-top: 8px;"><h4 style="color: #ffffff; margin: 0 0 4px 0; font-size: 0.9em;">Technical Stack</h4><p style="margin: 0; font-size: 0.75em;">JavaScript • Python • SQL • HTML/CSS • Supabase • Vercel • Database Design • API Integration • AI-Assisted Development</p></div></div>`;
            break;
        case 'contact':
            title = 'Contact';
            content = `<div class="contact-form"><div><input type="email" class="contact-email" placeholder="Your email" required style="width: 100%; padding: 8px; margin-bottom: 8px;"><textarea class="contact-message" placeholder="Your message" style="width: 100%; padding: 8px; margin-bottom: 8px; height: 80px;"></textarea><button class="contact-send" style="background: rgba(255, 255, 255, 0.2); border: 1px solid #ffffff; color: #ffffff; padding: 8px 16px; border-radius: 6px; cursor: pointer;">Send Message</button></div><div style="margin-top: 16px; padding-top: 12px; border-top: 1px solid rgba(255, 255, 255, 0.1);"><p style="margin: 6px 0; font-size: 0.9em;"><strong>Email:</strong> nadellasripad11@gmail.com</p><p style="margin: 6px 0; font-size: 0.9em;"><strong>GitHub:</strong> nadellasripad11</p><p style="margin: 10px 0 0 0; font-size: 0.8em; color: #94a3b8;">For personal, non-commercial conversations only.</p></div></div>`;
            break;
        case 'notes':
            title = 'Notes';
