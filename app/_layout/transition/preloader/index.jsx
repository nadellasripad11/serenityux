...
import { preloaderWords as defaultWords } from '@/data';
...
/** @param {Object} props @param {string[]} [props.words] */
export function Preloader({ words = defaultWords }) {
